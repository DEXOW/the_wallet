...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget buildNationalIDCard(Map<String, dynamic>? cardData) {
    return Container(
      margin: const EdgeInsets.only(bottom: 40), // Set the bottom margin of 40
      child: ClipRRect(
        borderRadius: BorderRadius.circular(10),
        child: Container(
          height: 225,
          width: MediaQuery.of(context).size.width * 0.9,
          color: const Color.fromARGB(255, 57, 114, 221),
          child: Column(
  ...
  Widget buildStudentIDCard(Map<String, dynamic>? cardData) {
    return Container(
        ...
        child: ClipRRect(
          ...
          child: Container(
            height: 225,
            color: const Color.fromARGB(255, 84, 193, 126),
            width: MediaQuery.of(context).size.width * 0.9,
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
  ...
  Widget buildMembershipIDCard(Map<String, dynamic>? cardData) {
    return Container(
        ...
        child: ClipRRect(
          ...
          child: Container(
            height: 225,
            color: const Color.fromARGB(255, 174, 95, 235),
            width: MediaQuery.of(context).size.width * 0.9,
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Container(
          height: 225,
          width: MediaQuery.of(context).size.width * 0.9,
          color: const Color.fromARGB(255, 235, 70, 111),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              SizedBox(height: MediaQuery.of(context).size.height * 0.025),
